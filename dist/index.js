...
(() => {
      ...
      cardWrappers.forEach((cardWrapper, index) => {
        ...
        if (innerWrapper && defaultImage) {
          ...
          innerWrapper.addEventListener("mouseover", () => {
            if (defaultImageSrc) {
              const hoverImageSrc = index < hoverImageSrcsFirstSection.length ? hoverImageSrcsFirstSection[index] : hoverImageSrcsSecondSection[index - hoverImageSrcsFirstSection.length];
    ...
    function toggleCardInnerContainer() {
      ...
      brandingImageCardContainer.forEach((element, index) => {
        element.addEventListener("click", () => {
          if (index === 0) {
            brandingAnimationWrapper.forEach((wrapper, index2) => {
      ...
      cardAnimationWrapper.forEach((wrapper, index) => {
        const innerContainer = cardInnerContainersHidden[index];
        wrapper.addEventListener("click", (event) => {
          event.stopPropagation();
  ...
  function startAnimation() {
    ...
    if (imageElements !== void 0 && imageElements.length > 8) {
  ...
  function changeNavbarDuringScroll() {
    ...
    const navbarCtaBtn = document.querySelector(".hero-cta");
    ...
    const elementSection1 = document.querySelector("#section-1");
